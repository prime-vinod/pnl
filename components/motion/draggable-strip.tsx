...
export function DraggableStrip({ items, speed = 50 }: Props) {
  ...
  return (
    <div
      ref={ref}
      className="cursor-grab touch-pan-x touch-pan-y select-none overflow-x-auto overscroll-x-contain scrollbar-none [-ms-overflow-style:none] active:cursor-grabbing [&::-webkit-scrollbar]:hidden"
